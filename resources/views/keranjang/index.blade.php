                            ...
                            @foreach($keranjang as $item)
                                ...
                                <tr>
                                    <td class="product-thumbnail">
                                        <img src="{{ asset('images/produk/'.$item->produk->gambar) }}" alt="Image" class="img-fluid" style="height: 100px">
                                    </td>
                                    ...
                                    <td>
                                        <div class="input-group mb-3 d-flex align-items-center jumlah-container" style="max-width: 120px;">
                                            <input type="number" class="form-control text-center jumlah-amount"
                                                value="{{ $item->jumlah }}" min="1" max="{{ $stokProduk }}"
            ...
            <div class="col-md-6">
                <div class="row mb-5">
                    <div class="col-md-6 mb-3 mb-md-0">
                        <button class="btn btn-black btn-sm btn-block" onclick="window.location='{{ route('belanja.index') }}'">Add Product</button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 text-right">
                                <strong class="text-black" id="cart-subtotal">{{ number_format($overallTotal, 2, '.', ',') }}</strong>
                            </div>
                        </div>
                        <div class="row mb-5">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6 text-right">
                                <strong class="text-black" id="cart-total">{{ number_format($overallTotal, 2, '.', ',') }}</strong>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
...
@push('scripts')
<script>
    function updateTotal(element, harga, stok, id) {
